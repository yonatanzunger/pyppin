...
class ListFilesTest(unittest.TestCase):
    def testListFiles(self) -> None:
        ...
        # OK, now let's see if we can list this mess correctly. Note that the only "real" files are
        # the ones we generated with calls to write() above; everything else is a symlink or
